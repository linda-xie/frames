...
description: Make your app shareable in social feeds
section_title: Guide
---
...
1. App adds an `fc:frame` meta tag to a page to make it shareable.
...
For example, we could create a Frame that shows the current price of ETH. We'd
...
If you are generating dynamic images there's a chance something goes wrong when
