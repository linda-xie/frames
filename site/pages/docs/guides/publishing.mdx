...
is hosted on rather than submitting information directly to a single entity.
...
In a nutshell, Mini Apps are:
- web apps
- idenitified by the domain they are hosted on
- owned by a single Farcaster Account 
- published by hosting a `/.well-known/farcaster.json` file

## Next Steps

Congratulations—you've published your Mini App! Before you start sharing your
app with users you'll want to:
- [make your app shareable in feeds](/docs/guides/sharing)
